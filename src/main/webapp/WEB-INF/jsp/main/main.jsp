		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<div class="logo-container">
					...
					<div class="brand">${user.nick_name}</div>
			...
			<div class="container">
				<div style="margin-bottom: 20px;">
					<button class="btn btn-primary"
						onclick="fnLocationInsertPartyPage();">모임 만들기</button>
				</div>
				<div class="content">
					<table class="table">
						<thead>
	...
	<footer class="footer footer-transparent">
		<div class="container">
			...
			<div class="social-area pull-right">
				<a class="btn btn-social btn-twitter btn-just-icon"
					href="https://twitter.com/CreativeTim"> <i
					class="fa fa-twitter"></i>
				</a> <a class="btn btn-social btn-facebook btn-just-icon"
					href="https://www.facebook.com/CreativeTim"> <i
					class="fa fa-facebook-square"></i>
				</a> <a class="btn btn-social btn-google btn-just-icon"
					href="https://plus.google.com/+CreativetimPage"> <i
					class="fa fa-google-plus"></i>
				</a>
			</div>
			<div class="copyright">&copy; 2016 Creative Tim, made with love
			</div>
		</div>
	</footer>
